...
4. **Der Kern bleibt framework-neutral.** CSS und JavaScript hängen nicht von Python oder Jinja ab;
   die Makros sind eine optionale Schicht darüber. Eine Änderung, die die reinen Assets ohne das
   Python-Paket unbrauchbar macht, gehört nicht in den Kern.
